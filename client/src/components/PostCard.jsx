...
const CommentForm = ({ user, id, replyAt, getComments }) => {
  ...
  return (
    <form
      ...
      className='w-full border-b border-yellow'
    >
      <div className='w-full flex items-center gap-2 py-4'>
        ...
        <TextInput
          name='comment'
          styles='w-full rounded-full py-3 border-yellow'
      ...
      <div className='flex items-end justify-end pb-2'>
        {loading ? (
          ...
          <CustomButton
            title='Submit'
            type='submit'
            containerStyles='bg-yellow text-white py-1 px-3 rounded-full font-semibold text-sm'
          />
        )}
      </div>
    </form>
  ...
  return (
    <div className='mb-2 bg-primary p-4 rounded-xl  hover:scale-105 duration-500 '>
      ...
      <div>
        <p className='text-ascent-2'>
          ...
          {post?.description?.length > 301 &&
            (showAll === post?._id ? (
              <span
                className='text-yellow ml-2 font-mediu cursor-pointer'
      ...
      {showComments === post?._id && (
        <div className='w-full mt-4 border-t border-yellow pt-4 '>
          <CommentForm
            user={user}
            id={post?._id}
