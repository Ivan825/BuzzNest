...
Before running the applications, ensure you have Node.js and npm installed on your system. You can download and install them from [Node.js official website](https://nodejs.org/).
...
2. Check if Node.js and npm are installed by running the following commands:
    ...
    npm -v
    ```
3. If Node.js and npm are not installed, follow the installation instructions provided on the Node.js website.
...
1. **Client:**
    ...
    - Start the client application:
        ...
        npm start
        ```
    - The client application should now be running. You can access it through your web browser at `http://localhost:3000`.
...
For any further inquiries or support, feel free to contact us at [buzznesthelp@outlook.com](mailto:support@example.com).
...
- [Bee Movie](https://en.wikipedia.org/wiki/Bee_Movie) - For inspiration
...
## Contact 
### Linkedin Profiles
- Kunal Mittal(Design/User Experience Curation) - [@kunal_freakun](https://www.linkedin.com/in/kunal-mittal-749a1a27b/)
- Ivan Bhargava(Front End / Deployment) - [@gimmecandandcheese](https://www.linkedin.com/in/ivan-bhargava/)
- Nirbhay Sharma(Back End / Version Control) - [@nirbhaysharma504](https://www.linkedin.com/in/nirbhay-sharma-575639280/)
### E-mail
- [Kunal_Mittal](kunal.mittal@iiitb.ac.in)
